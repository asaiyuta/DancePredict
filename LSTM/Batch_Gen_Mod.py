...
class batch_gen:
    ...
    def get_train_batch(self, index, batch_size, input_size, dist):
        self.max_index = self.length - (batch_size + input_size + dist + 1)
        self.u_index = index
        ...
        for i in range(batch_size):
            ...
            self.out_data.append(self.data[self.u_index + dist + i])
